...
//const char weekday_table[7][10] = { "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"};
/**
...
void alarm_init(void)
{
  ...
  alarm_struct.year  = 2022;
  alarm_struct.month = 9;
  alarm_struct.date  = 30;
  alarm_struct.hour  = 6;
  alarm_struct.min   = 0;
  alarm_struct.sec   = 20;
	//rtc_time_set(&alarm_struct);
	rtc_init(&alarm_struct);
